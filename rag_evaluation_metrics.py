"""
Comprehensive RAG Evaluation Metrics Library
Focuses on: Hallucination Detection, Cost & Tokens, Latency, Retrieval Quality, Generation Quality
"""
...
class HallucinationDetector:
    ...
    def extract_entities(self, text: str) -> List[str]:
        ...
        """
        # Pattern: Capital letter + lowercase letters, can have multiple words
    ...
    def entity_based_hallucination_detection(
        ...
        # Find hallucinated entities (in generated but not in source)
...
# ============================================================================
# 4. RETRIEVAL QUALITY METRICS (Hit Rate, MRR, NDCG)
# ============================================================================
...
# ============================================================================
# 5. GENERATION QUALITY METRICS (Faithfulness, Answer Relevance)
# ============================================================================
